...
%loztop
%exe_directory = '/home/loztop/Dropbox/Dphil/libmesh_git/weak_poro_paper/2D_convergence_sinh2/'
%output_plot_folder='/home/loztop/Dropbox/Dphil/libmesh_git/weak_poro_paper/2D_convergence_sinh2/matlab_files/converge/pdf_plots/'
...
res_directory =strcat([exe_directory 'data/matfiles/2D_convergence_paper/'])
...
hLegend = legend( ...
 ...
 strcat(['\gamma=',num2str(DELTA_BC(1))]) , ...
  ...
  strcat(['\gamma=',num2str(DELTA_BC(3))]) , ...
   '1st order ' , ...
   'location', 'SouthWest');
print(h,strcat([output_plot_folder,'disp_linf_h1_2D_TRI']),'-dpdf','-r0')
...
hLegend = legend( ...
  ...
  strcat(['\gamma=',num2str(DELTA_BC(3))]) , ...
   '2nd order ' , ...
   'location', 'SouthWest');
print(h,strcat([output_plot_folder,'disp_l2_l2_2D_TRI']),'-dpdf','-r0')
...
hLegend = legend( ...
  ...
  strcat(['\gamma=',num2str(DELTA_BC(3))]) , ...
   '1st order ' , ...
   'location', 'SouthWest');
print(h,strcat([output_plot_folder,'p_linf_l2_2D_TRI']),'-dpdf','-r0')
...
hold on;
Hd_w_h_hand(4)=plot(x_axis_NE,1*(-x_axis_NE+x_axis_NE(1)) -3,'--b','LineWidth',2,'MarkerSize',8)
hold on;
...
hLegend = legend( ...
  ...
  strcat(['\gamma=',num2str(DELTA_BC(3))]) , ...
   '1st order ' , ...
   'location', 'SouthWest');
print(h,strcat([output_plot_folder,'flux_l2_div_2D_TRI']),'-dpdf','-r0')
...
hLegend = legend( ...
  ...
  strcat(['\gamma=',num2str(DELTA_BC(3))]) , ...
   '2nd order ' , ...
   'location', 'SouthWest');
print(h,strcat([output_plot_folder,'flux_l2_l2_2D_TRI']),'-dpdf','-r0')
