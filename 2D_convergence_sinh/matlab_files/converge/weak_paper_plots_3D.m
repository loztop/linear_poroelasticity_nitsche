...
f_prefix='3D_weak_TET_0.001'

NE=[4,7,10,12];
NT=[4,7,10,12];
DELTA=[1];
DELTA_BC=[1, 1000, 1000000];
...
res_directory =strcat([exe_directory 'data/matfiles/3D_convergence_paper/'])
...
title('3D convergence of $||\mathbf{u}-\mathbf{u}_{h}||_{l^{\infty}(H^{1})}$','interpreter','latex','FontSize',19);
...
hLegend = legend( ...
 ...
 strcat(['\gamma=',num2str(DELTA_BC(1))]) , ...
  ...
  strcat(['\gamma=',num2str(DELTA_BC(3))]) , ...
   '1st order ' , ...
   'location', 'SouthWest');
print(h,strcat([output_plot_folder,'disp_linf_h1_3D_TRI']),'-dpdf','-r0')
...
hold on;
L2_u_h_hand(4)=plot(x_axis_NE,2*(-x_axis_NE+x_axis_NE(1)) -10,'--b','LineWidth',2,'MarkerSize',8)
hold on;

title('3D convergence of $||\mathbf{u}-\mathbf{u}_{h}||_{l^{2}(L^{2})}$','interpreter','latex','FontSize',19);
xlabel('$\log(1/\Delta t)$, $\log(1/\Delta h)$ ','interpreter','latex','FontSize',19)
ylabel('$\log(\mbox{error})$ ','interpreter','latex','FontSize',19)
 grid on;
set(gca,'YTick',[-17:1:-9])
set(gca,'XTick',[1:1:5])
axis([1 5 -17 -9])
set(h, 'Position', [100 100 700 700])
...
hLegend = legend( ...
  ...
  strcat(['\gamma=',num2str(DELTA_BC(3))]) , ...
   '2nd order ' , ...
   'location', 'SouthWest');
print(h,strcat([output_plot_folder,'disp_l2_l2_3D_TRI']),'-dpdf','-r0')
...
hold on;
L2_p_h_hand(4)=plot(x_axis_NE,1*(-x_axis_NE+x_axis_NE(1)) -5,'--b','LineWidth',2,'MarkerSize',8)
hold on;

title('3D convergence of $||{p}-{p}_{h}||_{l^{\infty}(L^{2})}$','interpreter','latex','FontSize',19);
xlabel('$\log(1/\Delta t)$, $\log(1/\Delta h)$ ','interpreter','latex','FontSize',19)
ylabel('$\log(\mbox{error})$ ','interpreter','latex','FontSize',19)
 grid on;
...
hLegend = legend( ...
  ...
  strcat(['\gamma=',num2str(DELTA_BC(3))]) , ...
   '1st order ' , ...
   'location', 'SouthWest');
print(h,strcat([output_plot_folder,'p_linf_l2_3D_TRI']),'-dpdf','-r0')
...
hold on;
Hd_w_h_hand(4)=plot(x_axis_NE,1*(-x_axis_NE+x_axis_NE(1)) -4,'--b','LineWidth',2,'MarkerSize',8)
hold on;

title('3D convergence of $||\nabla \cdot( \mathbf{z}-\mathbf{z}_{h})||_{l^{2}(L^{2})}$','interpreter','latex','FontSize',19);
xlabel('$\log(1/\Delta t)$, $\log(1/\Delta h)$ ','interpreter','latex','FontSize',19)
ylabel('$\log(\mbox{error})$ ','interpreter','latex','FontSize',19)
 grid on;
...
hLegend = legend( ...
  ...
  strcat(['\gamma=',num2str(DELTA_BC(3))]) , ...
   '1st order ' , ...
   'location', 'SouthWest');
print(h,strcat([output_plot_folder,'flux_l2_div_3D_TRI']),'-dpdf','-r0')
...
title('3D convergence of $|| \mathbf{z}-\mathbf{z}_{h}||_{l^{2}(L^{2})}$','interpreter','latex','FontSize',19);
xlabel('$\log(1/\Delta t)$, $\log(1/\Delta h)$ ','interpreter','latex','FontSize',19)
ylabel('$\log(\mbox{error})$ ','interpreter','latex','FontSize',19)
 grid on;
set(gca,'YTick',[-13:1:-3])
set(gca,'XTick',[1:1:5])
axis([1 5 -13 -3])
set(h, 'Position', [100 100 700 700])
...
hLegend = legend( ...
  ...
  strcat(['\gamma=',num2str(DELTA_BC(3))]) , ...
   '2nd order ' , ...
   'location', 'SouthWest');
print(h,strcat([output_plot_folder,'flux_l2_l2_3D_TRI']),'-dpdf','-r0')
