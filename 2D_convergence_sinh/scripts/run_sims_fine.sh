...
output_file_name_mat="$res_directory_mat$f_prefix"_"$k"_"$l"_"$str_nt$j"_"$str_ne$i"_.mat" "
...
exe_str=" $exe_directory$exe_filename $j $i $output_file_name_mat "exudos_dump" $k $l" 
